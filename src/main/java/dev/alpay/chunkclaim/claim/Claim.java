...
public class Claim {
    ...
    /** Yönetim bloğunu ana chunk içinde taşır (ana chunk değişmez). */
    public void relocateBlock(Location newLocation) {
        if (!originChunk.equals(ChunkKey.of(newLocation))) throw new IllegalArgumentException("Location is outside the origin chunk");
